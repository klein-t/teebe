...
Copyright (c) 2026 Klein Tahiraj. All rights reserved.
...
This means you **cannot** take Teebe's source, build a closed-source or
...
If you want to embed Teebe (in whole or in part) into a **proprietary or
closed-source product**, or otherwise distribute a derivative work **without**
the obligations of the GPL, you need a commercial license.

Commercial licenses are available from the copyright holder, Klein Tahiraj. They
...
Teebe can be offered under these terms because every contribution is covered by
the Contributor License Agreement (see [`CLA.md`](CLA.md)), which keeps a single,
unencumbered copyright able to license the project both ways.
